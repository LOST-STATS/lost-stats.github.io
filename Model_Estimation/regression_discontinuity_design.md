...
- The [Regression Kink Design](https://lost-stats.github.io/Model_Estimation/regression_kink_design.html) is an extension of RDD that looks for a change in *a relationship between the running variable and the outcome*, i.e. the slope, at the cutoff, rather than a change in the predicted outcome.
