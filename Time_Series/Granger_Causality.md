...
#### Plotting the IRF
Now that we have created our VAR model, we can plot how a shock to X will impact Y. To do this we will use the `irf()` function from the `vars` package and the base R plot function.
